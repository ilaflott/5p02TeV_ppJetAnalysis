// compile with...
// g++ rootMacro_noCode_templateOnly.C $(root-config --cflags --libs) -Werror -Wall -O2 -o rootMacro_noCode_templateOnly.exe
...
double trigComb(bool *trg, int *pscl, double pt);//ex1
void divideBinWidth(TH1 *h);//ex2
...
// int array initialization example
