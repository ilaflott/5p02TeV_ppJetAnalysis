...
filelist=jetRAA_PbPb_data_forests.txt
...
do
    ...
    Error="ak$algo$radius$jetType-PbPbData-$endfile.err"
    Output="ak$algo$radius$jetType-PbPbData-$endfile.out"
    Log="ak$algo$radius$jetType-PbPbData-$endfile.log"
    ...
    outfile="PbPb_Data_5p02TeV_ak${algo}${radius}${jetType}_20_eta_20_${endfile}.root"
