...
int SVDUnfoldDataSpectra_wNLO( std::string inFile_Data_dir , std::string inFile_MC_dir     , std::string inFile_MC_name     , 
  ...
  const std::string inFile_Data_name="/HighPtJetTrig_ak"+radiusint+"PF-allFiles.root";
...
int main(int argc, char* argv[]){  int rStatus = -1;
  ...
  rStatus=SVDUnfoldDataSpectra_wNLO(  (const std::string)argv[1], (const std::string)argv[2], (const std::string)argv[3], (const std::string)argv[4], 
				      (int)std::atoi(argv[5]) , (int)std::atoi(argv[6]) ,  (int)std::atoi(argv[7])  ,  (int)std::atoi(argv[8]) 
				      ); 
