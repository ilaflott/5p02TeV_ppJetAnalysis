...
//void ratioplot( TH1D* h1, TH1D* h2, TCanvas* c) {
//  bool funcDebug=true;
//  if(funcDebug)std::cout<<"in ratioplot function"<<std::endl;
//
//  c->cd();
//  
//  //setup pads + draw on canvases
...
//  h3->Draw("P E");       // Draw the ratio plot
//  // h1 settings
...
//  h3->GetYaxis()->SetTitleFont(43); // Absolute font size in pixel (precision 3)
...
//  h3->GetXaxis()->SetTitleFont(43); // Absolute font size in pixel (precision 3)
