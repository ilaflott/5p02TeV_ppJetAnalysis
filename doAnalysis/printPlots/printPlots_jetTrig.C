...
int printPlots_jetTrig ( const std::string input_ppData_condorDir ,   const std::string output_PDFname_base){
  ...
  //std::string input_ppDataJet80_Filename="HighPtJet80_" +fullJetType+ "-allFiles.root";
  //std::string input_ppDataLowJets_Filename="HighPtLowerJets_" +fullJetType+ "-allFiles.root";
  ...
  //const std::string ppDataJet80_fullFilename=inputDir+input_ppData_condorDir+input_ppDataJet80_Filename;
  //const std::string ppDataLowJets_fullFilename=inputDir+input_ppData_condorDir+input_ppDataLowJets_Filename;
  ...
  //std::string theJet80PDFFileName=outputDir+fullJetType+"_"+output_PDFname_base+"_jet80Only_jetTrig.pdf";
  //std::string open_theJet80PDFFileName=theJet80PDFFileName+"[";    std::string close_theJet80PDFFileName=theJet80PDFFileName+"]";  
  //std::string theLowJetsPDFFileName=outputDir+fullJetType+"_"+output_PDFname_base+"_lowjetsOnly_jetTrig.pdf";
  //std::string open_theLowJetsPDFFileName=theLowJetsPDFFileName+"[";    std::string close_theLowJetsPDFFileName=theLowJetsPDFFileName+"]";
  ...
  //temp_canvOpen->Print( open_theJet80PDFFileName.c_str() );  
  //temp_canvOpen->Print( open_theLowJetsPDFFileName.c_str() );    
  ...
  if(!drawJetTrigQAPlots)
    ...
    //// ----------------------------------    //INDIVIDUAL PD FILES
    //printTrigPtHist(finDataJet80, usedHLT100, false, usedMinBias, 
    //		    theJet80PDFFileName, fullJetType, "excl", radius, usedHLTPF , (TFile*) fout);
    //printTrigPtHist(finDataJet80, usedHLT100, false, usedMinBias, 
    //		    theJet80PDFFileName, fullJetType, "incl", radius, usedHLTPF , (TFile*) fout);    
    //// ----------------------------------    
    //for(int etabin=0;etabin<N_etabins;etabin++)
    //  printJetTrigHist_wRatio(finDataJet80, usedHLT100, usedMinBias, false, etabin,
    //			      theJet80PDFFileName, fullJetType, "excl", radius, usedHLTPF, doJetIDPlots , (TFile*) fout);
    //for(int etabin=0;etabin<N_etabins;etabin++)
    //  printJetTrigHist_wRatio(finDataJet80, usedHLT100, usedMinBias, false, etabin,
    //			      theJet80PDFFileName, fullJetType, "incl", radius, usedHLTPF, doJetIDPlots , (TFile*) fout);
    //
    //// ----------------------------------    //INDIVIDUAL PD FILES
    //printTrigPtHist(finDataLowJets, usedHLT100, false, usedMinBias, 
    //		    theLowJetsPDFFileName, fullJetType, "excl", radius, usedHLTPF , (TFile*) fout);
    //printTrigPtHist(finDataLowJets, usedHLT100, false, usedMinBias, 
    //		    theLowJetsPDFFileName, fullJetType, "incl", radius, usedHLTPF , (TFile*) fout);    
    //// ----------------------------------    
    //for(int etabin=0;etabin<N_etabins;etabin++)
    //  printJetTrigHist_wRatio(finDataLowJets, usedHLT100, usedMinBias, false, etabin,
    //			      theLowJetsPDFFileName, fullJetType, "excl", radius, usedHLTPF, doJetIDPlots , (TFile*) fout);
    //for(int etabin=0;etabin<N_etabins;etabin++)
    //  printJetTrigHist_wRatio(finDataLowJets, usedHLT100, usedMinBias, false, etabin,
    //			      theLowJetsPDFFileName, fullJetType, "incl", radius, usedHLTPF, doJetIDPlots , (TFile*) fout);
    //// ----------------------------------    //INDIVIDUAL PD FILES
    //for(int runind=0;runind<Nruns;runind++){
    //  printJetTrigHist_wRatio_vRun(finDataJet80, false,  runind,
    //				   theJet80PDFFileName, fullJetType, "excl", radius, usedHLTPF,  (TFile*) fout);
    //}
    //for(int runind=0;runind<Nruns;runind++){
    //  printJetTrigHist_wRatio_vRun(finDataJet80,  false,  runind,
    ...
    //}
    //for(int runind=0;runind<Nruns;runind++){
    //  printJetTrigHist_wRatio_vRun(finDataLowJets,  false,  runind,
    //				   theLowJetsPDFFileName, fullJetType, "incl", radius, usedHLTPF,  (TFile*) fout);	
    //}
    //for(int runind=0;runind<Nruns;runind++){
    //  printJetTrigHist_wRatio_vRun(finDataLowJets, false,  runind,
    ...
    //OLDER BUT MAYBE STILL INTERESTING
    //    // ----------------------------------    
  ...
  //temp_canvClose->Print( close_theLowJetsPDFFileName.c_str() );  
  //temp_canvClose->Print( close_theJet80PDFFileName.c_str() );  
