...
const bool drawJetQAPlots=true, drawDijetPlots=true, doBasicJetQAOnly=false;
const bool drawJetTrigQAPlots=true, drawJetRapBinsPlot=true, drawMCEffPlots=false;
