...
//StEventPool inherits all public/protected methods from TObject
class StEventPool : public TObject
{
 ...
 StEventPool() 
  ...
  //other constructor #1 w/ init list
 StEventPool(Int_t d) 
   : fEvents(0),
    fNTracksInEvent(0),
    fEventIndex(0),
  ...
  //other constructor #2 w/ init list
 StEventPool(Int_t d, Double_t multMin, Double_t multMax, 
  ...
  //public functions/data members of the classes of the class
...
//  deque<TObjArray*> GetEvents() { return fEvents; }
  ...
  //protected functions/data members of the class; these are only accesible by the class itself, or classes derived from this class
protected:
  ...
  ////private functions/datamembers of the class; these are only accesible by the class itself. 
  //private:
  
  ////the ClassDef function is for ROOT to better implement custom class w/ ROOT I/O, etc.
