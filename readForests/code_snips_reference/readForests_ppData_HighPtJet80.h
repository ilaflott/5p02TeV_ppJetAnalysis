...
// this script specialized to read HighPtJet80 2015 ePrompt reco data
// all readForests_ppData functionality remains the same
...
//filelists/5p02TeV_HighPtJet80_9Files_debug_forests.txt";
const int defRadius=4;
const std::string defJetType="PF";
const std::string defOutputName = "readForests_ppData_HighPtJet80_defOut.root";
const bool defDebugMode = true;
int readForests_ppData_HighPtJet80(int startfile = defStartFile , int endfile = defEndFile ,
