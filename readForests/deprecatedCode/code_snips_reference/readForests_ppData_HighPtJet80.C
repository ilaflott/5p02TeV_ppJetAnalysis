// custom header
#include "readForests_ppData_HighPtJet80.h"

const double jtPtCut=15., ldJetPtCut=50., subldJetPtCut=20., jetQAPtCut=50.;

//// readForests_ppData
// ---------------------------------------------------------------------------------------------------------------
int readForests_ppData_HighPtJet80(int startfile , int endfile , std::string inFilelist , std::string outfile ,
...
int main(int argc, char *argv[]){
  ...
  if(argc!=8 && argc!=1){
    ...
    std::cout<<"./readForests_ppData_HighPtJet80.exe";
    std::cout<<std::endl<<std::endl;
  ...
  // good input, run
  rStatus=1;
  if(argc==1) rStatus = readForests_ppData_HighPtJet80();
    ...
    rStatus = readForests_ppData_HighPtJet80( startfile, endfile, inputFileList, outputFileName,
