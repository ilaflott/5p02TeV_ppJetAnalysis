...
// compile with...
// g++ readForests_ppData_HighPtLowerJets.C $(root-config --cflags --libs) -Werror -Wall -O2 -o readForests_ppData_HighPtLowerJets.exe
...
const std::string defOutputName = "readForests_ppData_HighPtLowerJets_defOut.root";
const bool defDebugMode = true;
int readForests_ppData_HighPtLowerJets(int startfile = defStartFile , int endfile = defEndFile ,
...
/*  //CaloJet Triggers                          */ //PFJet Triggers
/*  const std::string HLTBitStrings[N_L1Bits]={ */ const std::string HLTBitStrings[N_L1Bits]={
/*  "HLT_AK4CaloJet40_Eta5p1",                  */   "HLT_AK4PFJet40_Eta5p1",
/*  "HLT_AK4CaloJet60_Eta5p1",                  */   "HLT_AK4PFJet60_Eta5p1",
/*  "HLT_AK4CaloJet80_Eta5p1",                  */   "HLT_AK4PFJet80_Eta5p1",
/*  "HLT_AK4CaloJet100_Eta5p1"                  */   "HLT_AK4PFJet100_Eta5p1"
/*   };                                         */ };
