...
const float defYCutLo=0.0, defYCutHi=2.0; //really absycut, don't use negative numbers

int readForests_ppData_jetPlots_v2( std::string inFilelist=defDataInFilelist, 
