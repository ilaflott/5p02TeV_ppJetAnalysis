...
int readForests_ppData_jetPlots( std::string inFilelist , int startfile , int endfile , 
  ...
  TH1F  *hpp_TrgObj40[2]={}, *hpp_TrgObj60[2]={}, *hpp_TrgObj80[2]={}, *hpp_TrgObj100[2]={};// for incl spectra for each individual trigger
  TH1F  *hpp_ExcTrgObj40[2]={}, *hpp_ExcTrgObj60[2]={}, *hpp_ExcTrgObj80[2]={}, *hpp_ExcTrgObj100[2]={};// for trigger-exclusive inclusive jet spectra
...
//      { is100 = true;  weight_eS=trgPscl[3]; }
    ...
    if(fillDataJetTrigQAHists){
      ...
      if(trgDec[0])   hpp_IncHLT40trgPt->Fill(  (float)trgPt, trgPscl[0] );
      if(trgDec[1])   hpp_IncHLT60trgPt->Fill(  (float)trgPt, trgPscl[1] );
