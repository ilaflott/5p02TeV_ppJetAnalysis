...
source condorSubmit_readForests.sh readForests_ppData_jetPlots -1 12 0 filelists/5p02TeV_HighPtJet80_forests.txt     ${R} PF 0 ${etaLo} ${etaHi}
...
source condorSubmit_readForests.sh readForests_ppData_jetPlots -1 12 0 filelists/5p02TeV_HighPtLowerJets_forests.txt ${R} PF 0 ${etaLo} ${etaHi}
