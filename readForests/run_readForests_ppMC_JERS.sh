...
### test job
#source condorSubmit_readForests.sh readForests_ppMC_JERS 1 40 0 filelists/5p02TeV_Py8_CUETP8M1_QCDjetAllPtBins_Official_forests.txt 4 PF 0 0 2.0

### all regions
#source condorSubmit_readForests.sh readForests_ppMC_JERS -1 40 0 filelists/5p02TeV_Py8_CUETP8M1_QCDjetAllPtBinsOfficial_forests.txt 4 PF 0 0 4.7

### barrel/endcap only
#source condorSubmit_readForests.sh readForests_ppMC_JERS -1 50 0 filelists/5p02TeV_Py8_CUETP8M1_QCDjetAllPtBins_Official_forests.txt 4 PF 0 0 2.0
